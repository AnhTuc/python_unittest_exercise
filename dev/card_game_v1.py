...
from dev.deck_v1 import Deck


class CardGame:
    
    def __init__(self, player_score =60, reward = 20, cost = 25):
        self.reward = reward
        self.cost = cost
    ...
    def introduction(func):
        ...
        def inner(self,*args, **kwargs):
            print("Welcome to card game! I am be your host of today!")
            print("Game Start!")
            time.sleep(1)
